  		...
  		function getcity(obj) {  
		    ...
		    var proviceid;
		     for(var i=0;i<obj.options.length;i++){
		   	...
		   	var url = "${pageContext.request.contextPath }/cascadeAction!ajaxCityListById.action?id=" + proviceid;  
		    $.ajax({  
		        type : "POST",  
		        url : url,  
		        data : {},  
		        ...
		        success : function(data) {  
		            ...
		            for(var n=0;n<data.length;n++){  
		              var ids=data[n].id;  
		                var names=data[n].cityName;  
		                $("#city").append("<option id='"+ids+"' value='"+names+"'>"+names+"</option>");  
		                } 
		       		 }   
   			 	}) 
			}  
